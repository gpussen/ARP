...
# Line efficiency for 5% losses (5% range; adjust to 0.75-0.80 if needed)
...
for v in villages:
    ...
    # --- ADD VARIANCE HERE ---
    # 1. Add 5% random noise so they aren't identical flat lines
...
# 6. Reindex and fill as per your original script
...
# Coal config (assumed values; adjust as needed)
coal_conf = {
...
# Diesel config (adjusted for consistency)
diesel_conf = {
    "capital_cost": 20000,  # INR/kW
    "fom": 0,
    "vom": 0,
...
diesel_ann_capex = annualized_capex(diesel_conf["capital_cost"], diesel_conf["lifetime"], diesel_conf["wacc"])
...
n.add("Generator",
      ...
      marginal_cost=coal_conf["marginal_cost"],
      capital_cost=coal_ann_capex + coal_conf["fom"],
      lifetime=coal_conf["lifetime"])
...
# ==========================================================
# 1. LOAD CHARACTERISTICS (Rabi vs Normal)
# ==========================================================
...
# ==========================================================
# 2. DAILY LOAD CURVES (INCLUDING SUGAR MILL)
# ==========================================================
...
# ==========================================================
# 3. MONTHLY LOAD TREND COMPARISON
# ==========================================================
